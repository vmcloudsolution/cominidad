                ...
                if vat_type and vat_type.upper() == 'PED':
                    ...
                    if int(vat[10]) == dig_check:
                        ...
                        try: #EVUGOR
                            ...
                            raise osv.except_osv('Error de conexión', 'No se puede conectar con la SUNAT \nintentelo nuevamente o verífique que la página SUNAT \n"Consulta RUC" esté disponible')
